...
public class AsciiPanel extends JPanel {
    ...
    public AsciiPanel writeRight(String string, int y) {
    	return writeRight(string, y, defaultForegroundColor, defaultBackgroundColor);
    }
    
    public AsciiPanel writeRight(String string, int y, Color foreground) {
    	return writeRight(string, y, foreground, defaultBackgroundColor);
    }
    
    public AsciiPanel writeRight(String string, int y, Color foreground, Color background) {
        if (string == null)
            throw new NullPointerException("string must not be null." );
        ...
        int x = (widthInCharacters - string.length());
